...
const agents: Agent[] = [
  { name: 'Sales Agent', domain: 'Sales', description: 'Automate the sales pipeline.', status: 'Building', metric: 'Lead Response Time < 5 Mins', metricLabel: 'response time', color: 'coral', capabilities: ['Lead qualification', 'Lead scoring', 'Meeting scheduling', 'CRM updates'] },
  { name: 'Research Agent', domain: 'Research', description: 'Continuously gather business intelligence.', status: 'Building', metric: '20', metricLabel: 'reports / month', color: 'blue', capabilities: ['Competitor monitoring', 'Trend analysis', 'Market research', 'Product research'] },
  { name: 'Support Agent', domain: 'Experience', description: 'Provide 24/7 support across chat, WhatsApp, and email.', status: 'Building', metric: '90%', metricLabel: 'resolution target', color: 'mint', capabilities: ['FAQ handling', 'Course guidance', 'Troubleshooting', 'Omnichannel support'] },
  { name: 'School Outreach Agent', domain: 'Partnerships', description: 'Automate partnership outreach. School Research, Personalized Outreach, Follow-up Management, CRM Updates.', status: 'Building', metric: '100', metricLabel: 'activities / week', color: 'yellow', capabilities: ['School research', 'Personalized outreach', 'Follow-up management', 'CRM updates'] },
  { name: 'Content Research Agent', domain: 'Marketing', description: 'Spot hooks, trends, and growth opportunities. Trend Analysis, Keyword Research, Content Ideation, Competitor Tracking.', status: 'Building', metric: '20', metricLabel: 'opportunities / week', color: 'lavender', capabilities: ['Trend research', 'Hook discovery', 'Content monitoring', 'Opportunity detection'] },
  { name: 'HR Agent', domain: 'People', description: 'Automate HR operations. Resume Screening, Candidate Ranking, Interview Scheduling, FAQ Support.', status: 'Building', metric: '↓', metricLabel: 'hiring time', color: 'peach', capabilities: ['Resume screening', 'Candidate ranking', 'Interview scheduling', 'HR FAQs'] },
  { name: 'Learning Coach Agent', domain: 'Learning', description: 'Act as a personalized student mentor with learning recommendations and motivation', status: 'Building', metric: 'completion rate', metricLabel: 'course completion', color: 'coral', capabilities: ['Recommendations', 'Motivation', 'Progress tracking', 'Revision support'] },
  { name: 'Analytics Agent', domain: 'Operations', description: 'Automatically generate insights through dashboard monitoring and KPI analysis.', status: 'Building', metric: '100%', metricLabel: 'automated reports', color: 'blue', capabilities: ['KPI analysis', 'Dashboard monitoring', 'Weekly reports', 'Anomaly detection'] },
  { name: 'SOP Agent', domain: 'Operations', description: 'Answer operational questions instantly with process guidance.', status: 'Building', metric: '90%', metricLabel: 'resolution target', color: 'mint', capabilities: ['SOP retrieval', 'Process guidance', 'Policy assistance', 'Source citations'] },
  { name: 'Orchestration System', domain: 'Platform', description: 'Enable agents to collaborate.', status: 'Building', metric: 'Cross-Agent Success Rate', metricLabel: 'agents in pipeline', color: 'yellow', capabilities: ['Routing', 'Handoffs', 'Retries', 'Human approval gates'] },
  { name: 'Evaluation Monitor', domain: 'Platform', description: 'Measure agent quality.', status: 'Building', metric: '95% Agent Accuracy', metricLabel: 'accuracy target', color: 'lavender', capabilities: ['Accuracy scoring', 'Task completion', 'Satisfaction', 'Hallucination checks'] },
  { name: 'Agent Marketplace', domain: 'Platform', description: 'Create reusable internal agents.', status: 'Building', metric: '20 Internal Agents', metricLabel: 'agent target', color: 'peach', capabilities: ['Agent catalog', 'Versioning', 'Permissions', 'Usage analytics'] },
]
