...
export async function qualifyLead(input: z.infer<typeof leadSchema>) {
...
export async function resolveSupport(input: z.infer<typeof questionSchema>) {
...
export async function createResearchReport(query: string) {
...
export async function draftOutreach(input: z.infer<typeof schoolSchema>) {
...
export async function discoverContent(input: z.infer<typeof contentSchema>) {
...
export async function screenCandidate(input: z.infer<typeof candidateSchema>) {
...
export async function coachLearner(input: z.infer<typeof learnerSchema>) {
...
export async function analyzeMetrics(input: z.infer<typeof analyticsSchema>) {
...
export async function answerSop(input: z.infer<typeof sopSchema>) {
...
export async function runOrchestration(input: z.infer<typeof orchestrationSchema>) {
...
export async function evaluateTask(input: z.infer<typeof evaluationSchema>) {
...
export async function publishAgent(input: z.infer<typeof marketplaceSchema>) {
